...
def tela_login():
    ...
    imagem_mostrar_senha_rect = imagem_mostrar_senha.get_rect()
    ...
    fonte_input = pygame.font.Font("Fonts/arial.ttf", 15)
    ...
    while executando_tela:
        ...
        #Mostrar senha 
        tela.blit(imagem_mostrar_senha, (363, 300))
        ...
        tela.blit(texto_surface1, (105+5, 168))
